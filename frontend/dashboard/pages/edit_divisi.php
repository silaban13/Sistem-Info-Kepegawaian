...
$json = file_get_contents(
    "http://localhost:8080/Sistem-Info-Kepegawaian/backend/api/index.php?route=divisi/show&id=".$id
);
...
<input
id="nama_divisi"
value="<?= htmlspecialchars($divisi['nama_divisi']) ?>"

<div id="jabatanLoading" class="flex justify-center items-center py-20">
    <div class="flex flex-col items-center gap-3">
        <div class="w-12 h-12 border-4 border-blue-600 border-t-transparent rounded-full animate-spin"></div>
        <p class="text-gray-500">Memuat data jabatan...</p>
    </div>
</div>

<div id="jabatanContent" class="hidden">
    ...
    <div class="space-y-6">
        ...
        <div id="modalJabatan" class="hidden fixed inset-0 bg-black/10 backdrop-blur-sm flex items-center justify-center z-50">
        ...
        <div id="modalTambahJabatan" class="hidden fixed inset-0 bg-black/5 backdrop-blur-[2px] flex items-center justify-center z-50">
            <div class="bg-white rounded-2xl shadow-xl w-[95%] sm:w-full max-w-md p-6">
...
<script>
    ...
    async function loadJabatan(page = 1)
    {
        document.getElementById("jabatanLoading").classList.remove("hidden");
        document.getElementById("jabatanContent").classList.add("hidden");
        try {
            const response = await getData("jabatan&page=" + page);
            let html = "";
            ...
            document.getElementById("jabatanLoading").classList.add("hidden");
            document.getElementById("jabatanContent").classList.remove("hidden");

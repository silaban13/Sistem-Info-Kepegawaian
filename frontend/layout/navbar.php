    ...
    <div class="max-w-7xl mx-auto flex items-center justify-between h-20 px-6 lg:px-16">
       ...
       <ul class="hidden lg:flex items-center gap-8 text-sm font-medium">
        ...
        <div class="hidden lg:flex items-center gap-4">
            <input type="text" placeholder="Cari Pegawai..." class="w-64 px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:outline-none">
...
<div id="offcanvas" class="fixed top-0 right-0 h-screen w-80 bg-white shadow-2xl translate-x-full transition-all duration-300 ease-in-out z-50 flex flex-col">
    <div class="flex items-center justify-between p-6 border-b">
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-lg bg-blue-600 flex items-center justify-center">
                <span class="text-white font-bold">SI</span>
            </div>
            <div>
    ...
    <div class="flex-1 px-4 space-y-2">
        <a href="/Sistem-Info-Kepegawaian/index.php?page=home" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition">
            <span>Home</span>
        </a>
        <a href="/Sistem-Info-Kepegawaian/index.php?page=about" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition">
            <span>About</span>
        </a>
        <a href="/Sistem-Info-Kepegawaian/index.php?page=contact" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition">
            <span>Contact</span>
        </a>
    </div>
</div>